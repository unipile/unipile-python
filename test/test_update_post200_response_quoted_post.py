...
class TestUpdatePost200ResponseQuotedPost(unittest.TestCase):
    """UpdatePost200ResponseQuotedPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePost200ResponseQuotedPost:
        """Test UpdatePost200ResponseQuotedPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePost200ResponseQuotedPost`
        """
        model = UpdatePost200ResponseQuotedPost()
        if include_optional:
            return UpdatePost200ResponseQuotedPost(
                object = 'Post',
                id = '',
                share_url = '',
                created_at = '',
    ...
    def testUpdatePost200ResponseQuotedPost(self):
        """Test UpdatePost200ResponseQuotedPost"""
