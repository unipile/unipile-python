            ...
            return PerformClassicSearchFromUrl200Response(
                data = [
                    unipile.models.posts_search_results_data_inner.Posts_search_results_data_inner(
                        ...
                        title = '', 
                        text = '', 
                        author = unipile.models.update_chat_200_response_participants_inner_user.updateChat_200_response_participants_inner_user(
                            id = '', 
                            object = 'User', 
                            type = 'individual', 
                            public_identifier = '', 
                        ...
                        specifics = null, 
                        is_repost = True, 
                        reposted_by = unipile.models.update_chat_200_response_participants_inner_user.updateChat_200_response_participants_inner_user(
                            id = '', 
                            object = 'User', 
                            type = 'individual', 
                            public_identifier = '', 
