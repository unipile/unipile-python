            ...
            return PerformClassicSearchFromUrl200Response(
                data = [
                    unipile.models.posts_search_results_data_inner.Posts_search_results_data_inner(
                        ...
                        title = '', 
                        text = '', 
                        author = unipile.models.get_chats_list_200_response_data_inner_last_message_any_of_1_sender.getChatsList_200_response_data_inner_last_message_anyOf_1_sender(
                            id = '', 
                            object = 'User', 
                            type = 'individual', 
                            public_identifier = '', 
                        ...
                        specifics = null, 
                        is_repost = True, 
                        reposted_by = unipile.models.get_chats_list_200_response_data_inner_last_message_any_of_1_sender.getChatsList_200_response_data_inner_last_message_anyOf_1_sender(
                            id = '', 
                            object = 'User', 
                            type = 'individual', 
                            public_identifier = '', 
