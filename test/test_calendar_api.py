...
class TestCalendarApi(unittest.TestCase):
    ...
    def test_cancel_calendar_event(self) -> None:
        """Test case for cancel_calendar_event
    ...
    def test_restore_calendar_event(self) -> None:
        """Test case for restore_calendar_event

        Restore a cancelled calendar event
        """
        pass

    def test_set_calendar_event_rsvp(self) -> None:
        """Test case for set_calendar_event_rsvp
