...
class TestPostsSearchResults(unittest.TestCase):
    """PostsSearchResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostsSearchResults:
        """Test PostsSearchResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostsSearchResults`
        """
        model = PostsSearchResults()
        if include_optional:
    ...
    def testPostsSearchResults(self):
        """Test PostsSearchResults"""
