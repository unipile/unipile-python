...
class TestGetUserProfile200ResponseSpecificsAllOfAnyOf(unittest.TestCase):
    """GetUserProfile200ResponseSpecificsAllOfAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserProfile200ResponseSpecificsAllOfAnyOf:
        """Test GetUserProfile200ResponseSpecificsAllOfAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserProfile200ResponseSpecificsAllOfAnyOf`
        """
        model = GetUserProfile200ResponseSpecificsAllOfAnyOf()
        if include_optional:
            return GetUserProfile200ResponseSpecificsAllOfAnyOf(
                member_urn = '',
    ...
    def testGetUserProfile200ResponseSpecificsAllOfAnyOf(self):
        """Test GetUserProfile200ResponseSpecificsAllOfAnyOf"""
