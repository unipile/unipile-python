    ...
    def make_instance(self, include_optional) -> PerformRecruiterPeopleSearchFromTalentPoolRequest:
        ...
        if include_optional:
            return PerformRecruiterPeopleSearchFromTalentPoolRequest(
                ...
                load_custom_filter = unipile.models.get_email_contacts_list_200_response_data_inner_groups_inner.getEmailContactsList_200_response_data_inner_groups_inner(
                    id = '', ),
                ...
                years_of_experience = unipile.models.get_recruiter_talent_pool_applicants_request_years_of_experience.getRecruiterTalentPoolApplicants_request_years_of_experience(
                    min = 1.337, 
                    max = 1.337, ),
                years_in_current_position = unipile.models.get_recruiter_talent_pool_applicants_request_years_of_experience.getRecruiterTalentPoolApplicants_request_years_of_experience(
                    min = 1.337, 
                    max = 1.337, ),
                years_in_current_company = unipile.models.get_recruiter_talent_pool_applicants_request_years_of_experience.getRecruiterTalentPoolApplicants_request_years_of_experience(
                    min = 1.337, 
                    max = 1.337, ),
                ...
                tags = unipile.models.perform_recruiter_people_search_from_talent_pool_request_degree.performRecruiterPeopleSearchFromTalentPool_request_degree(
                    include = [
                        ''
                        ], 
                    exclude = [
