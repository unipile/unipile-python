...
json = "{}"
# create an instance of PeopleSearchDataInner from a JSON string
people_search_data_inner_instance = PeopleSearchDataInner.from_json(json)
# print the JSON string representation of the object
print(PeopleSearchDataInner.to_json())

# convert the object into a dict
people_search_data_inner_dict = people_search_data_inner_instance.to_dict()
# create an instance of PeopleSearchDataInner from a dict
people_search_data_inner_from_dict = PeopleSearchDataInner.from_dict(people_search_data_inner_dict)
```
