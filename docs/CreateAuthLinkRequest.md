...
------------ | ------------- | ------------- | -------------
**account_scope_id** | **str** | The Scope the account will be assigned to once authentication is complete. | [optional] 
...
json = "{}"
# create an instance of CreateAuthLinkRequest from a JSON string
create_auth_link_request_instance = CreateAuthLinkRequest.from_json(json)
# print the JSON string representation of the object
print(CreateAuthLinkRequest.to_json())

# convert the object into a dict
create_auth_link_request_dict = create_auth_link_request_instance.to_dict()
# create an instance of CreateAuthLinkRequest from a dict
create_auth_link_request_from_dict = CreateAuthLinkRequest.from_dict(create_auth_link_request_dict)
```
