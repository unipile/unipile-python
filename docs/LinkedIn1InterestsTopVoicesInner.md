# LinkedIn1InterestsTopVoicesInner
...
**specifics** | [**LinkedIn**](LinkedIn.md) |  | [optional] 
...
json = "{}"
# create an instance of LinkedIn1InterestsTopVoicesInner from a JSON string
linked_in1_interests_top_voices_inner_instance = LinkedIn1InterestsTopVoicesInner.from_json(json)
# print the JSON string representation of the object
print(LinkedIn1InterestsTopVoicesInner.to_json())

# convert the object into a dict
linked_in1_interests_top_voices_inner_dict = linked_in1_interests_top_voices_inner_instance.to_dict()
# create an instance of LinkedIn1InterestsTopVoicesInner from a dict
linked_in1_interests_top_voices_inner_from_dict = LinkedIn1InterestsTopVoicesInner.from_dict(linked_in1_interests_top_voices_inner_dict)
```
