...
**notify** | **bool** | Whether invited attendees should be notified when the event is created. Defaults to &#x60;false&#x60;.           - Outlook Calendar: unsupported. Attendees are always notified regardless of this value. | [optional] [default to False]
