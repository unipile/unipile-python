# GetContactsList200ResponseDataInnerUser
...
json = "{}"
# create an instance of GetContactsList200ResponseDataInnerUser from a JSON string
get_contacts_list200_response_data_inner_user_instance = GetContactsList200ResponseDataInnerUser.from_json(json)
# print the JSON string representation of the object
print(GetContactsList200ResponseDataInnerUser.to_json())

# convert the object into a dict
get_contacts_list200_response_data_inner_user_dict = get_contacts_list200_response_data_inner_user_instance.to_dict()
# create an instance of GetContactsList200ResponseDataInnerUser from a dict
get_contacts_list200_response_data_inner_user_from_dict = GetContactsList200ResponseDataInnerUser.from_dict(get_contacts_list200_response_data_inner_user_dict)
```
