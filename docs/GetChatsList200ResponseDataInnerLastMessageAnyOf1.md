# GetChatsList200ResponseDataInnerLastMessageAnyOf1
...
**attachments** | [**List[GetChatsList200ResponseDataInnerLastMessageAnyOf1AttachmentsInner]**](GetChatsList200ResponseDataInnerLastMessageAnyOf1AttachmentsInner.md) | List of message attachments. | 
...
```python
from unipile.models.get_chats_list200_response_data_inner_last_message_any_of1 import GetChatsList200ResponseDataInnerLastMessageAnyOf1

# TODO update the JSON string below
json = "{}"
# create an instance of GetChatsList200ResponseDataInnerLastMessageAnyOf1 from a JSON string
get_chats_list200_response_data_inner_last_message_any_of1_instance = GetChatsList200ResponseDataInnerLastMessageAnyOf1.from_json(json)
# print the JSON string representation of the object
print(GetChatsList200ResponseDataInnerLastMessageAnyOf1.to_json())

# convert the object into a dict
get_chats_list200_response_data_inner_last_message_any_of1_dict = get_chats_list200_response_data_inner_last_message_any_of1_instance.to_dict()
# create an instance of GetChatsList200ResponseDataInnerLastMessageAnyOf1 from a dict
get_chats_list200_response_data_inner_last_message_any_of1_from_dict = GetChatsList200ResponseDataInnerLastMessageAnyOf1.from_dict(get_chats_list200_response_data_inner_last_message_any_of1_dict)
```
