...
json = "{}"
# create an instance of LinkedIn2Credentials from a JSON string
linked_in2_credentials_instance = LinkedIn2Credentials.from_json(json)
# print the JSON string representation of the object
print(LinkedIn2Credentials.to_json())

# convert the object into a dict
linked_in2_credentials_dict = linked_in2_credentials_instance.to_dict()
# create an instance of LinkedIn2Credentials from a dict
linked_in2_credentials_from_dict = LinkedIn2Credentials.from_dict(linked_in2_credentials_dict)
```
