...
**school** | [**LinkedIn1EducationInnerSchool**](LinkedIn1EducationInnerSchool.md) |  | 
...
json = "{}"
# create an instance of LinkedIn1EducationInner from a JSON string
linked_in1_education_inner_instance = LinkedIn1EducationInner.from_json(json)
# print the JSON string representation of the object
print(LinkedIn1EducationInner.to_json())

# convert the object into a dict
linked_in1_education_inner_dict = linked_in1_education_inner_instance.to_dict()
# create an instance of LinkedIn1EducationInner from a dict
linked_in1_education_inner_from_dict = LinkedIn1EducationInner.from_dict(linked_in1_education_inner_dict)
```
