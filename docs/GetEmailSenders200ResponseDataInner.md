...
**signature** | **str** | HTML signature configured for this address, when the provider exposes one (Gmail). It is not appended automatically when sending: include it yourself at the end of the &#x60;body&#x60;/&#x60;html&#x60; of the email. Absent when the address has no signature, and not supported by Outlook. | [optional] 
