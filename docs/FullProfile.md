...
json = "{}"
# create an instance of FullProfile from a JSON string
full_profile_instance = FullProfile.from_json(json)
# print the JSON string representation of the object
print(FullProfile.to_json())

# convert the object into a dict
full_profile_dict = full_profile_instance.to_dict()
# create an instance of FullProfile from a dict
full_profile_from_dict = FullProfile.from_dict(full_profile_dict)
```
