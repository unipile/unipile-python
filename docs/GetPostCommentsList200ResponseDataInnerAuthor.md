...
json = "{}"
# create an instance of GetPostCommentsList200ResponseDataInnerAuthor from a JSON string
get_post_comments_list200_response_data_inner_author_instance = GetPostCommentsList200ResponseDataInnerAuthor.from_json(json)
# print the JSON string representation of the object
print(GetPostCommentsList200ResponseDataInnerAuthor.to_json())

# convert the object into a dict
get_post_comments_list200_response_data_inner_author_dict = get_post_comments_list200_response_data_inner_author_instance.to_dict()
# create an instance of GetPostCommentsList200ResponseDataInnerAuthor from a dict
get_post_comments_list200_response_data_inner_author_from_dict = GetPostCommentsList200ResponseDataInnerAuthor.from_dict(get_post_comments_list200_response_data_inner_author_dict)
```
