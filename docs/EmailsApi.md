...
# **get_emails_list**
> GetEmailsList200Response get_emails_list(account_id, to=to, subject=subject, var_from=var_from, any_email=any_email, before=before, exclude_folder=exclude_folder, after=after, meta_only=meta_only, offset=offset, cursor=cursor, limit=limit)
...
with unipile.ApiClient(configuration) as api_client:
    ...
    try:
        # List all Emails
        api_response = api_instance.get_emails_list(account_id, to=to, subject=subject, var_from=var_from, any_email=any_email, before=before, exclude_folder=exclude_folder, after=after, meta_only=meta_only, offset=offset, cursor=cursor, limit=limit)
...
> GetEmailsList200Response get_folder_emails_list(folder_id, account_id, to=to, subject=subject, var_from=var_from, any_email=any_email, before=before, exclude_folder=exclude_folder, after=after, meta_only=meta_only, offset=offset, cursor=cursor, limit=limit)
...
with unipile.ApiClient(configuration) as api_client:
    ...
    try:
        # List folder Emails
        api_response = api_instance.get_folder_emails_list(folder_id, account_id, to=to, subject=subject, var_from=var_from, any_email=any_email, before=before, exclude_folder=exclude_folder, after=after, meta_only=meta_only, offset=offset, cursor=cursor, limit=limit)
