...
**recurrence** | **List[Optional[str]]** | List of RRULE, EXRULE, RDATE and EXDATE lines for a recurring event, as specified in RFC5545. | [optional] 
...
**specifics** | **object** | Object containing provider-specific calendar event data. | [optional] 
...
get_calendar_event_list200_response_data_inner_instance = GetCalendarEventList200ResponseDataInner.from_json(json)
# print the JSON string representation of the object
print(GetCalendarEventList200ResponseDataInner.to_json())

# convert the object into a dict
get_calendar_event_list200_response_data_inner_dict = get_calendar_event_list200_response_data_inner_instance.to_dict()
# create an instance of GetCalendarEventList200ResponseDataInner from a dict
get_calendar_event_list200_response_data_inner_from_dict = GetCalendarEventList200ResponseDataInner.from_dict(get_calendar_event_list200_response_data_inner_dict)
```
