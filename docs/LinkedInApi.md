...
> PostsSearchResults perform_classic_posts_search(account_id, cursor=cursor, perform_classic_posts_search_request=perform_classic_posts_search_request)
...
with unipile.ApiClient(configuration) as api_client:
    ...
    try:
        # Perform Posts Search
        api_response = api_instance.perform_classic_posts_search(account_id, cursor=cursor, perform_classic_posts_search_request=perform_classic_posts_search_request)
