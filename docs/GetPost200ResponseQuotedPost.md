...
**specifics** | [**GetPostsList200ResponseDataInnerSpecifics**](GetPostsList200ResponseDataInnerSpecifics.md) |  | [optional] 

## Example

```python
from unipile.models.get_post200_response_quoted_post import GetPost200ResponseQuotedPost

# TODO update the JSON string below
json = "{}"
# create an instance of GetPost200ResponseQuotedPost from a JSON string
get_post200_response_quoted_post_instance = GetPost200ResponseQuotedPost.from_json(json)
# print the JSON string representation of the object
print(GetPost200ResponseQuotedPost.to_json())

# convert the object into a dict
get_post200_response_quoted_post_dict = get_post200_response_quoted_post_instance.to_dict()
# create an instance of GetPost200ResponseQuotedPost from a dict
get_post200_response_quoted_post_from_dict = GetPost200ResponseQuotedPost.from_dict(get_post200_response_quoted_post_dict)
```
