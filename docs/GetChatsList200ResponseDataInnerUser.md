...
json = "{}"
# create an instance of GetChatsList200ResponseDataInnerUser from a JSON string
get_chats_list200_response_data_inner_user_instance = GetChatsList200ResponseDataInnerUser.from_json(json)
# print the JSON string representation of the object
print(GetChatsList200ResponseDataInnerUser.to_json())

# convert the object into a dict
get_chats_list200_response_data_inner_user_dict = get_chats_list200_response_data_inner_user_instance.to_dict()
# create an instance of GetChatsList200ResponseDataInnerUser from a dict
get_chats_list200_response_data_inner_user_from_dict = GetChatsList200ResponseDataInnerUser.from_dict(get_chats_list200_response_data_inner_user_dict)
```
