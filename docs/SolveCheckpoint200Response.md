...
**status** | **str** | The current status of the account.     - &#x60;running&#x60; is Operational.     - &#x60;errored&#x60; is Service Interuption.     - &#x60;disconnected&#x60; is Require Authentication..     - &#x60;paused&#x60; is Paused.     Learn more about [Status &amp; Lifecycle](https://developer.unipile.com/v2.0/docs/status-lifecycle). | 
