# LinkedInInterestsTopVoicesInnerSpecifics
...
json = "{}"
# create an instance of LinkedInInterestsTopVoicesInnerSpecifics from a JSON string
linked_in_interests_top_voices_inner_specifics_instance = LinkedInInterestsTopVoicesInnerSpecifics.from_json(json)
# print the JSON string representation of the object
print(LinkedInInterestsTopVoicesInnerSpecifics.to_json())

# convert the object into a dict
linked_in_interests_top_voices_inner_specifics_dict = linked_in_interests_top_voices_inner_specifics_instance.to_dict()
# create an instance of LinkedInInterestsTopVoicesInnerSpecifics from a dict
linked_in_interests_top_voices_inner_specifics_from_dict = LinkedInInterestsTopVoicesInnerSpecifics.from_dict(linked_in_interests_top_voices_inner_specifics_dict)
```
