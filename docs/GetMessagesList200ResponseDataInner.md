...
json = "{}"
# create an instance of GetMessagesList200ResponseDataInner from a JSON string
get_messages_list200_response_data_inner_instance = GetMessagesList200ResponseDataInner.from_json(json)
# print the JSON string representation of the object
print(GetMessagesList200ResponseDataInner.to_json())

# convert the object into a dict
get_messages_list200_response_data_inner_dict = get_messages_list200_response_data_inner_instance.to_dict()
# create an instance of GetMessagesList200ResponseDataInner from a dict
get_messages_list200_response_data_inner_from_dict = GetMessagesList200ResponseDataInner.from_dict(get_messages_list200_response_data_inner_dict)
```
