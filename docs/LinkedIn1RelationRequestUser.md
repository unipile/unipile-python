...
json = "{}"
# create an instance of LinkedIn1RelationRequestUser from a JSON string
linked_in1_relation_request_user_instance = LinkedIn1RelationRequestUser.from_json(json)
# print the JSON string representation of the object
print(LinkedIn1RelationRequestUser.to_json())

# convert the object into a dict
linked_in1_relation_request_user_dict = linked_in1_relation_request_user_instance.to_dict()
# create an instance of LinkedIn1RelationRequestUser from a dict
linked_in1_relation_request_user_from_dict = LinkedIn1RelationRequestUser.from_dict(linked_in1_relation_request_user_dict)
```
