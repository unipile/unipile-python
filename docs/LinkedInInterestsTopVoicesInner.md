# LinkedInInterestsTopVoicesInner
...
**specifics** | [**GetChatsList200ResponseDataInnerUserSpecificsAnyOf1**](GetChatsList200ResponseDataInnerUserSpecificsAnyOf1.md) |  | [optional] 
...
json = "{}"
# create an instance of LinkedInInterestsTopVoicesInner from a JSON string
linked_in_interests_top_voices_inner_instance = LinkedInInterestsTopVoicesInner.from_json(json)
# print the JSON string representation of the object
print(LinkedInInterestsTopVoicesInner.to_json())

# convert the object into a dict
linked_in_interests_top_voices_inner_dict = linked_in_interests_top_voices_inner_instance.to_dict()
# create an instance of LinkedInInterestsTopVoicesInner from a dict
linked_in_interests_top_voices_inner_from_dict = LinkedInInterestsTopVoicesInner.from_dict(linked_in_interests_top_voices_inner_dict)
```
