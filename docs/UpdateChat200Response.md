...
**muted_until** | [**GetChat200ResponseMutedUntil**](GetChat200ResponseMutedUntil.md) |  | 
...
**folders** | **List[str]** | A list of folders the chat belongs to. | 
...
**participants** | [**List[UpdateChat200ResponseParticipantsInner]**](UpdateChat200ResponseParticipantsInner.md) | List of participants in the chat if group chat. | [optional] 
**last_message** | [**GetChat200ResponseLastMessage**](GetChat200ResponseLastMessage.md) |  | [optional] 
**user** | [**GetChatsList200ResponseDataInnerLastMessageAnyOf1Sender**](GetChatsList200ResponseDataInnerLastMessageAnyOf1Sender.md) |  | [optional] 
...
json = "{}"
# create an instance of UpdateChat200Response from a JSON string
update_chat200_response_instance = UpdateChat200Response.from_json(json)
# print the JSON string representation of the object
print(UpdateChat200Response.to_json())

# convert the object into a dict
update_chat200_response_dict = update_chat200_response_instance.to_dict()
# create an instance of UpdateChat200Response from a dict
update_chat200_response_from_dict = UpdateChat200Response.from_dict(update_chat200_response_dict)
```
