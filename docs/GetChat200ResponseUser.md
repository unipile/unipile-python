...
```python
from unipile.models.get_chat200_response_user import GetChat200ResponseUser

# TODO update the JSON string below
json = "{}"
# create an instance of GetChat200ResponseUser from a JSON string
get_chat200_response_user_instance = GetChat200ResponseUser.from_json(json)
# print the JSON string representation of the object
print(GetChat200ResponseUser.to_json())

# convert the object into a dict
get_chat200_response_user_dict = get_chat200_response_user_instance.to_dict()
# create an instance of GetChat200ResponseUser from a dict
get_chat200_response_user_from_dict = GetChat200ResponseUser.from_dict(get_chat200_response_user_dict)
```
