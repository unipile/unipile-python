...
json = "{}"
# create an instance of GetUserRelations200ResponseDataInnerUser from a JSON string
get_user_relations200_response_data_inner_user_instance = GetUserRelations200ResponseDataInnerUser.from_json(json)
# print the JSON string representation of the object
print(GetUserRelations200ResponseDataInnerUser.to_json())

# convert the object into a dict
get_user_relations200_response_data_inner_user_dict = get_user_relations200_response_data_inner_user_instance.to_dict()
# create an instance of GetUserRelations200ResponseDataInnerUser from a dict
get_user_relations200_response_data_inner_user_from_dict = GetUserRelations200ResponseDataInnerUser.from_dict(get_user_relations200_response_data_inner_user_dict)
```
