...
**user** | [**GetChat200ResponseUser**](GetChat200ResponseUser.md) |  | [optional] 
...
json = "{}"
# create an instance of GetChat200Response from a JSON string
get_chat200_response_instance = GetChat200Response.from_json(json)
# print the JSON string representation of the object
print(GetChat200Response.to_json())

# convert the object into a dict
get_chat200_response_dict = get_chat200_response_instance.to_dict()
# create an instance of GetChat200Response from a dict
get_chat200_response_from_dict = GetChat200Response.from_dict(get_chat200_response_dict)
```
