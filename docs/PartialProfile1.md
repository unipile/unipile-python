...
partial_profile1_instance = PartialProfile1.from_json(json)
# print the JSON string representation of the object
print(PartialProfile1.to_json())

# convert the object into a dict
partial_profile1_dict = partial_profile1_instance.to_dict()
# create an instance of PartialProfile1 from a dict
partial_profile1_from_dict = PartialProfile1.from_dict(partial_profile1_dict)
```
