...
**skills** | [**List[LinkedInSkillsInner]**](LinkedInSkillsInner.md) | A collection of the user&#39;s skills. | [optional] 
**experience** | [**List[LinkedInExperienceInner]**](LinkedInExperienceInner.md) | A collection of the user&#39;s professionnal experiences. | [optional] 
**education** | [**List[LinkedInEducationInner]**](LinkedInEducationInner.md) | A collection of the user&#39;s education. | [optional] 
**languages** | [**List[LinkedInLanguagesInner]**](LinkedInLanguagesInner.md) | A collection of the user&#39;s languages. | [optional] 
**certifications** | [**List[LinkedInCertificationsInner]**](LinkedInCertificationsInner.md) | A collection of the user&#39;s certifications. | [optional] 
**volunteer_experience** | [**List[LinkedInVolunteerExperienceInner]**](LinkedInVolunteerExperienceInner.md) | A collection of the user&#39;s volunteering experiences. | [optional] 
**projects** | [**List[LinkedInProjectsInner]**](LinkedInProjectsInner.md) | A collection of the user&#39;s projects. | [optional] 
**recommendations** | [**LinkedInRecommendations**](LinkedInRecommendations.md) |  | [optional] 
**interests** | [**LinkedInInterests**](LinkedInInterests.md) |  | [optional] 
...
get_user_profile200_response_specifics_instance = GetUserProfile200ResponseSpecifics.from_json(json)
# print the JSON string representation of the object
print(GetUserProfile200ResponseSpecifics.to_json())

# convert the object into a dict
get_user_profile200_response_specifics_dict = get_user_profile200_response_specifics_instance.to_dict()
# create an instance of GetUserProfile200ResponseSpecifics from a dict
get_user_profile200_response_specifics_from_dict = GetUserProfile200ResponseSpecifics.from_dict(get_user_profile200_response_specifics_dict)
```
