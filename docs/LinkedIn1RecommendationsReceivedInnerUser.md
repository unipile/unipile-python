# LinkedIn1RecommendationsReceivedInnerUser
...
json = "{}"
# create an instance of LinkedIn1RecommendationsReceivedInnerUser from a JSON string
linked_in1_recommendations_received_inner_user_instance = LinkedIn1RecommendationsReceivedInnerUser.from_json(json)
# print the JSON string representation of the object
print(LinkedIn1RecommendationsReceivedInnerUser.to_json())

# convert the object into a dict
linked_in1_recommendations_received_inner_user_dict = linked_in1_recommendations_received_inner_user_instance.to_dict()
# create an instance of LinkedIn1RecommendationsReceivedInnerUser from a dict
linked_in1_recommendations_received_inner_user_from_dict = LinkedIn1RecommendationsReceivedInnerUser.from_dict(linked_in1_recommendations_received_inner_user_dict)
```
