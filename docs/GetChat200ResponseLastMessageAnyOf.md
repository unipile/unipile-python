# GetChat200ResponseLastMessageAnyOf
...
json = "{}"
# create an instance of GetChat200ResponseLastMessageAnyOf from a JSON string
get_chat200_response_last_message_any_of_instance = GetChat200ResponseLastMessageAnyOf.from_json(json)
# print the JSON string representation of the object
print(GetChat200ResponseLastMessageAnyOf.to_json())

# convert the object into a dict
get_chat200_response_last_message_any_of_dict = get_chat200_response_last_message_any_of_instance.to_dict()
# create an instance of GetChat200ResponseLastMessageAnyOf from a dict
get_chat200_response_last_message_any_of_from_dict = GetChat200ResponseLastMessageAnyOf.from_dict(get_chat200_response_last_message_any_of_dict)
```
