...
> AddPostCommentReaction200Response add_post_comment_reaction(post_id, comment_id, account_id, add_post_reaction_request)
...
with unipile.ApiClient(configuration) as api_client:
    ...
    try:
        # Add Reaction to a Comment
        api_response = api_instance.add_post_comment_reaction(post_id, comment_id, account_id, add_post_reaction_request)
...
> RemovePostCommentReaction200Response remove_post_comment_reaction(post_id, comment_id, account_id, remove_post_reaction_request)
...
with unipile.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove Reaction from a Comment
        api_response = api_instance.remove_post_comment_reaction(post_id, comment_id, account_id, remove_post_reaction_request)
