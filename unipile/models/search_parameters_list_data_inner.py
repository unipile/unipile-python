...
class SearchParametersListDataInner(BaseModel):
    """
    ...
    metadata: Optional[SearchParametersListDataInnerMetadata] = None
    __properties: ClassVar[List[str]] = ["object", "id", "name", "metadata"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SearchParameter']):
            raise ValueError("must be one of enum values ('SearchParameter')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "metadata": SearchParametersListDataInnerMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
