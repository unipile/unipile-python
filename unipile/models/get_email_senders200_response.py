...
class GetEmailSenders200Response(BaseModel):
    """
    GetEmailSenders200Response
    """ # noqa: E501
    data: List[GetEmailSenders200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetEmailSenders200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
