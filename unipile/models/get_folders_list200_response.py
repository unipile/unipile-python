...
class GetFoldersList200Response(BaseModel):
    """
    GetFoldersList200Response
    """ # noqa: E501
    data: List[GetFoldersList200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetFoldersList200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
