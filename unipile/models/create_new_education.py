...
class CreateNewEducation(BaseModel):
    ...
    skills: Optional[List[CreateNewExperienceSkillsInner]] = Field(default=None, description="Skills to associate with this education entry. Use this field only inside `education`; it is independent from the profile-level and experience `skills` fields. These skills also appear in the profile Skills section.")
