...
class CreateNewEducation(BaseModel):
    ...
    school: UpdateUserProfileRequestSpecificsAllOfLinkedinSkillsInner
    degree: Optional[UpdateUserProfileRequestSpecificsAllOfLinkedinSkillsInner] = None
    field_of_study: Optional[UpdateUserProfileRequestSpecificsAllOfLinkedinSkillsInner] = None
    start_date: CreateNewExperienceStartDate
    end_date: Optional[CreateNewExperienceStartDate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "school": UpdateUserProfileRequestSpecificsAllOfLinkedinSkillsInner.from_dict(obj["school"]) if obj.get("school") is not None else None,
            "degree": UpdateUserProfileRequestSpecificsAllOfLinkedinSkillsInner.from_dict(obj["degree"]) if obj.get("degree") is not None else None,
            "field_of_study": UpdateUserProfileRequestSpecificsAllOfLinkedinSkillsInner.from_dict(obj["field_of_study"]) if obj.get("field_of_study") is not None else None,
            "start_date": CreateNewExperienceStartDate.from_dict(obj["start_date"]) if obj.get("start_date") is not None else None,
            "end_date": CreateNewExperienceStartDate.from_dict(obj["end_date"]) if obj.get("end_date") is not None else None,
            "grade": obj.get("grade"),
