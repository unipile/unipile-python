...
class ApplyOnExternalWebsite(BaseModel):
    """
    ApplyOnExternalWebsite
    """ # noqa: E501
    method: StrictStr
    website_url: StrictStr = Field(description="The website on which applications should be made.")
    __properties: ClassVar[List[str]] = ["method", "website_url"]
