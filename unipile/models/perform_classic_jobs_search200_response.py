...
class PerformClassicJobsSearch200Response(BaseModel):
    """
    PerformClassicJobsSearch200Response
    """ # noqa: E501
    data: List[PerformClassicJobsSearch200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PerformClassicJobsSearch200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
