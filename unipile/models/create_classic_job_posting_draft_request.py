...
class CreateClassicJobPostingDraftRequest(BaseModel):
    ...
    location: StrictStr = Field(description="A parameter ID. Use <a href=\"https://developer.unipile.com/v2.0/reference/getclassicsearchparameters\">List Search Parameters</a> with `JOB_LOCATION` type to find out the possible values.")
    ...
    skills: Optional[List[Optional[StrictStr]]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getclassicsearchparameters\">List Search Parameters</a> with `SKILL` type to find out the possible values. The skills related to the job posting.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "screening_questions": [CreateClassicJobPostingDraftRequestScreeningQuestionsInner.from_dict(_item) for _item in obj["screening_questions"]] if obj.get("screening_questions") is not None else None,
