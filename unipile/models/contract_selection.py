...
class ContractSelection(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    contracts: List[CreateRecruiterHiringProjectRequestJobTitle] = Field(description="A list of contracts to choose from.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "contracts": [CreateRecruiterHiringProjectRequestJobTitle.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None
        })
        return _obj
