...
class GetMessageReactionsList200Response(BaseModel):
    """
    GetMessageReactionsList200Response
    """ # noqa: E501
    data: List[GetMessageReactionsList200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetMessageReactionsList200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
