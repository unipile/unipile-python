...
class PerformRecruiterPeopleSearchRequest(BaseModel):
    ...
    industry: Optional[PerformRecruiterPeopleSearchFromTalentPoolRequestDegree] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "industry": PerformRecruiterPeopleSearchFromTalentPoolRequestDegree.from_dict(obj["industry"]) if obj.get("industry") is not None else None,
