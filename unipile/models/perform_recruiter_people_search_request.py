...
class PerformRecruiterPeopleSearchRequest(BaseModel):
    ...
    profile_language: Optional[List[StrictStr]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getrecruitersearchparameters\">List Search Parameters</a> with `PROFILE_LANGUAGE` type to find out the possible values.    Native filter : Profile languages   ")
    ...
    group: Optional[List[StrictStr]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getrecruitersearchparameters\">List Search Parameters</a> with `GROUP` type to find out the possible values.    Native filter : All groups   ")
