...
class ModifyEmailRequestSpecificsAllOfOutlook(BaseModel):
    """
    Specific options to apply if the provider of the targeted account is Outlook.
    """ # noqa: E501
    categories: Optional[List[StrictStr]] = Field(default=None, description="List of categories to assign to the email.")
