...
class GetChat200ResponseUser(BaseModel):
    """
    ...
    specifics: Optional[GetChat200ResponseUserSpecifics] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specifics": GetChat200ResponseUserSpecifics.from_dict(obj["specifics"]) if obj.get("specifics") is not None else None
        })
        return _obj
