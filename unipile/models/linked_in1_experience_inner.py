...
class LinkedIn1ExperienceInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "company": LinkedIn1ExperienceInnerCompany.from_dict(obj["company"]) if obj.get("company") is not None else None,
