...
class PerformRecruiterPeopleSearchFromTalentPoolRequest(BaseModel):
    ...
    employment_type: Optional[List[StrictStr]] = Field(default=None, description="A list of employment types. Only available to Recruiter PRO contracts.    Native filter : Employment type   ")
    ...
    spoken_language: Optional[List[PerformRecruiterPeopleSearchFromTalentPoolRequestSpokenLanguageInner]] = Field(default=None, description="A list of languages. Only available to Recruiter PRO contracts.    Native filter : Spoken languages   ")
    profile_language: Optional[List[Optional[StrictStr]]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getrecruitersearchparameters\">List Search Parameters</a> with `PROFILE_LANGUAGE` type to find out the possible values.    Native filter : Profile languages   ")
    project: Optional[PerformRecruiterPeopleSearchFromTalentPoolRequestProject] = None
    job_function: Optional[List[StrictStr]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getrecruitersearchparameters\">List Search Parameters</a> with `JOB_FUNCTION` type to find out the possible values.    Native filter : Job functions   ")
    ...
    group: Optional[List[Optional[StrictStr]]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getrecruitersearchparameters\">List Search Parameters</a> with `GROUP` type to find out the possible values.    Native filter : All groups   ")
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.location:
            for _item_location in self.location:
                _items.append(_item_location.to_dict() if _item_location is not None else None)
        ...
        if self.postal_code:
            for _item_postal_code in self.postal_code:
                _items.append(_item_postal_code.to_dict() if _item_postal_code is not None else None)
        ...
        if self.job_title:
            for _item_job_title in self.job_title:
                _items.append(_item_job_title.to_dict() if _item_job_title is not None else None)
        ...
        if self.occupation:
            for _item_occupation in self.occupation:
                _items.append(_item_occupation.to_dict() if _item_occupation is not None else None)
        ...
        if self.company:
            for _item_company in self.company:
                _items.append(_item_company.to_dict() if _item_company is not None else None)
        ...
        if self.current_company:
            for _item_current_company in self.current_company:
                _items.append(_item_current_company.to_dict() if _item_current_company is not None else None)
        ...
        if self.past_company:
            for _item_past_company in self.past_company:
                _items.append(_item_past_company.to_dict() if _item_past_company is not None else None)
        ...
        if self.company_size:
            for _item_company_size in self.company_size:
                _items.append(_item_company_size.to_dict() if _item_company_size is not None else None)
        ...
        if self.school:
            for _item_school in self.school:
                _items.append(_item_school.to_dict() if _item_school is not None else None)
            _dict['school'] = _items
        ...
        if self.field_of_study:
            for _item_field_of_study in self.field_of_study:
                _items.append(_item_field_of_study.to_dict() if _item_field_of_study is not None else None)
        ...
        if self.spoken_language:
            for _item_spoken_language in self.spoken_language:
                _items.append(_item_spoken_language.to_dict() if _item_spoken_language is not None else None)
        ...
        if self.recently_joined:
            for _item_recently_joined in self.recently_joined:
                _items.append(_item_recently_joined.to_dict() if _item_recently_joined is not None else None)
        ...
        if self.recruiting_activity:
            for _item_recruiting_activity in self.recruiting_activity:
                _items.append(_item_recruiting_activity.to_dict() if _item_recruiting_activity is not None else None)
