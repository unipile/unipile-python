...
class PerformRecruiterPeopleSearchFromTalentPoolRequest(BaseModel):
    """
    ...
    load_custom_filter: Optional[GetEmailContactsList200ResponseDataInnerGroupsInner] = None
    ...
    occupation: Optional[List[PerformRecruiterPeopleSearchFromTalentPoolRequestJobTitleInner]] = Field(default=None, description="A list of occupations.")
    ...
    current_company: Optional[List[GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner]] = Field(default=None, description="A list of current companies.")
    past_company: Optional[List[GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner]] = Field(default=None, description="A list of past companies.")
    ...
    years_in_current_position: Optional[GetRecruiterTalentPoolApplicantsRequestYearsOfExperience] = None
    years_in_current_company: Optional[GetRecruiterTalentPoolApplicantsRequestYearsOfExperience] = None
    ...
    school: Optional[List[GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner]] = Field(default=None, description="A list of schools.")
    field_of_study: Optional[List[GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner]] = Field(default=None, description="A list of fields of study.")
    ...
    group: Optional[List[Optional[StrictStr]]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/get_v2-account-id-linkedin-recruiter-search-parameters\">List Search Parameters</a> with `GROUP` type to find out the possible values.    Native filter : All groups   ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "load_custom_filter": GetEmailContactsList200ResponseDataInnerGroupsInner.from_dict(obj["load_custom_filter"]) if obj.get("load_custom_filter") is not None else None,
            ...
            "occupation": [PerformRecruiterPeopleSearchFromTalentPoolRequestJobTitleInner.from_dict(_item) for _item in obj["occupation"]] if obj.get("occupation") is not None else None,
            ...
            "current_company": [GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner.from_dict(_item) for _item in obj["current_company"]] if obj.get("current_company") is not None else None,
            "past_company": [GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner.from_dict(_item) for _item in obj["past_company"]] if obj.get("past_company") is not None else None,
            ...
            "years_in_current_position": GetRecruiterTalentPoolApplicantsRequestYearsOfExperience.from_dict(obj["years_in_current_position"]) if obj.get("years_in_current_position") is not None else None,
            "years_in_current_company": GetRecruiterTalentPoolApplicantsRequestYearsOfExperience.from_dict(obj["years_in_current_company"]) if obj.get("years_in_current_company") is not None else None,
            ...
            "school": [GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner.from_dict(_item) for _item in obj["school"]] if obj.get("school") is not None else None,
            "field_of_study": [GetRecruiterTalentPoolApplicantsRequestSpokenLanguageInner.from_dict(_item) for _item in obj["field_of_study"]] if obj.get("field_of_study") is not None else None,
            ...
            "notes": obj.get("notes"),
            "tags": PerformRecruiterPeopleSearchFromTalentPoolRequestDegree.from_dict(obj["tags"]) if obj.get("tags") is not None else None,
