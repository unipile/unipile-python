...
class PerformRecruiterPeopleSearchFromTalentPoolRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["keywords", "network_distance", "location", "postal_code", "postal_code_radius", "job_title", "occupation", "skills", "company", "company_size", "years_of_experience", "school", "graduation_year", "industry", "seniority", "profile_language", "project", "function", "first_name", "last_name", "recently_joined", "is_military_veteran", "recruiting_activity", "hide_previously_viewed", "group", "is_past_applicant", "notes", "channel_id"]
