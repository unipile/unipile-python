...
class StartChat200Response(BaseModel):
    """
    StartChat200Response
    """ # noqa: E501
    object: StrictStr
    chat_id: StrictStr = Field(description="The ID of the started chat.")
    message_id: Optional[StartChat200ResponseMessageId]
    __properties: ClassVar[List[str]] = ["object", "chat_id", "message_id"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ChatStarted']):
            raise ValueError("must be one of enum values ('ChatStarted')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message_id": StartChat200ResponseMessageId.from_dict(obj["message_id"]) if obj.get("message_id") is not None else None
        })
        return _obj
