...
class ResendCheckpointRequest(BaseModel):
    """
    ResendCheckpointRequest
    """ # noqa: E501
    intent_id: Annotated[str, Field(strict=True)] = Field(description="The ID of the intent for which a checkpoint must be resent.")
