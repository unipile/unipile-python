...
class GetPostsList200ResponseDataInnerQuotedPost(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "share_url", "created_at", "title", "text", "author", "user_reacted", "permissions", "reactions_counter", "comments_counter", "reposts_counter", "poll", "attachments", "analytics"]
