...
class PerformClassicSearchFromUrl200ResponseAnyOf1(BaseModel):
    """
    PerformClassicSearchFromUrl200ResponseAnyOf1
    """ # noqa: E501
    data: List[PerformClassicSearchFromUrl200ResponseAnyOf1DataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PerformClassicSearchFromUrl200ResponseAnyOf1DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
