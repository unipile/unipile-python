...
class LinkNewAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account_scope_id", "expires_on", "domain", "redirect_uri", "state", "config", "providers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providers": LinkNewAccountProviders.from_dict(obj["providers"]) if obj.get("providers") is not None else None
        })
        return _obj
