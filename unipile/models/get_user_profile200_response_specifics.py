...
class GetUserProfile200ResponseSpecifics(BaseModel):
    ...
    skills: Optional[List[LinkedInSkillsInner]] = Field(default=None, description="A collection of the user's skills.")
    experience: Optional[List[LinkedInExperienceInner]] = Field(default=None, description="A collection of the user's professionnal experiences.")
    education: Optional[List[LinkedInEducationInner]] = Field(default=None, description="A collection of the user's education.")
    languages: Optional[List[LinkedInLanguagesInner]] = Field(default=None, description="A collection of the user's languages.")
    certifications: Optional[List[LinkedInCertificationsInner]] = Field(default=None, description="A collection of the user's certifications.")
    volunteer_experience: Optional[List[LinkedInVolunteerExperienceInner]] = Field(default=None, description="A collection of the user's volunteering experiences.")
    projects: Optional[List[LinkedInProjectsInner]] = Field(default=None, description="A collection of the user's projects.")
    recommendations: Optional[LinkedInRecommendations] = None
    interests: Optional[LinkedInInterests] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interests": LinkedInInterests.from_dict(obj["interests"]) if obj.get("interests") is not None else None,
