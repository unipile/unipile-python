...
class GetUserProfile200ResponseSpecifics(BaseModel):
    ...
    industry: Optional[StrictStr] = Field(default=None, description="The industry of the user's current company.")
    ...
    __properties: ClassVar[List[str]] = ["member_id", "industry", "can_send_inmail", "network_distance", "relation_request", "relation_request_status", "pronoun", "default_locale", "supported_locales", "notify_visit_token", "is_open_profile", "is_premium", "is_influencer", "is_creator", "is_hiring", "is_open_to_work", "is_saved_lead", "is_crm_imported", "skills", "experience", "education", "languages", "certifications", "volunteer_experience", "projects", "recommendations", "interests", "throttled_sections", "recruiting_profile", "messaging_identifier", "is_mutual_contact", "is_close_friend", "is_bot", "is_support", "is_scam", "is_fake", "is_restricted", "restrictions", "status", "common_chats_count", "contact_name"]
