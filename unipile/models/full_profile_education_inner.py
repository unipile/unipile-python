...
class FullProfileEducationInner(BaseModel):
    ...
    skills: Optional[List[StrictStr]] = Field(default=None, description="Skills acquired through training.")
    ...
    fields_of_study: Optional[List[StrictStr]] = Field(default=None, description="Fields of study of the education.")
