...
class PerformClassicSearchFromUrl200ResponseAnyOfDataInnerCompany(BaseModel):
    """
    The company that published the Job posting.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the Company.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "public_identifier", "profile_url", "public_picture_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PerformClassicSearchFromUrl200ResponseAnyOfDataInnerCompany from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PerformClassicSearchFromUrl200ResponseAnyOfDataInnerCompany from a dict"""
        if obj is None:
            return None
