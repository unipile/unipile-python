...
class PostsSearchResultsDataInner(BaseModel):
    ...
    author: UpdateChat200ResponseParticipantsInnerUser
    ...
    reposted_by: Optional[UpdateChat200ResponseParticipantsInnerUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "text": obj.get("text"),
            "author": UpdateChat200ResponseParticipantsInnerUser.from_dict(obj["author"]) if obj.get("author") is not None else None,
            ...
            "reposted_by": UpdateChat200ResponseParticipantsInnerUser.from_dict(obj["reposted_by"]) if obj.get("reposted_by") is not None else None,
