...
class WhatsApp(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": WhatsAppCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "config": WhatsAppConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
