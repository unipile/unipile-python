...
class LinkedIn2(BaseModel):
    ...
    credentials: LinkedIn2Credentials
    config: Optional[LinkedIn2Config] = None
    __properties: ClassVar[List[str]] = ["provider", "user_timezone", "credentials", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": LinkedIn2Credentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "config": LinkedIn2Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
