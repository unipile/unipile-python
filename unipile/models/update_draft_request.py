...
class UpdateDraftRequest(BaseModel):
    ...
    to: Optional[List[GetEmailsList200ResponseDataInnerFromInner]] = Field(default=None, description="List of attendees to set in `to` header.")
    ...
    __properties: ClassVar[List[str]] = ["html", "plain_text", "subject", "from", "to", "cc", "bcc", "reply_to", "reply_to_message_id", "attachments", "tracking_options", "specifics"]
