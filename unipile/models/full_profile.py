...
class FullProfile(BaseModel):
    ...
    recommendations: List[LinkedIn1RecommendationsReceivedInner]
    __properties: ClassVar[List[str]] = ["id", "member_id", "display_name", "public_identifier", "profile_url", "public_picture_url", "public_picture_url_large", "relations_count", "location", "headline", "can_send_inmail", "network_distance", "visibility", "candidate_id", "is_hidden_candidate", "hiring_project", "work_experience", "industry", "followers_count", "skills", "summary", "emails", "phone_numbers", "education", "languages", "certifications", "projects", "volunteering", "recommendations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recommendations": [LinkedIn1RecommendationsReceivedInner.from_dict(_item) for _item in obj["recommendations"]] if obj.get("recommendations") is not None else None
        })
        return _obj
