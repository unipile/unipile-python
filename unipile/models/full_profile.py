...
class FullProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["visibility", "id", "candidate_id", "headline", "network_distance", "location", "is_hidden_candidate", "work_experience", "can_send_inmail", "display_name", "public_identifier", "profile_url", "industry", "relations_count", "followers_count", "skills", "summary", "public_picture_url", "emails", "phone_numbers", "education", "languages", "certifications", "projects", "volunteering", "recommendations"]
