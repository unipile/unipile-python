...
class FullProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "member_id", "display_name", "public_identifier", "profile_url", "public_picture_url", "public_picture_url_large", "relations_count", "location", "headline", "network_distance", "can_send_inmail", "visibility", "candidate_id", "is_hidden_candidate", "hiring_project", "work_experience", "industry", "followers_count", "skills", "summary", "emails", "phone_numbers", "education", "languages", "certifications", "projects", "volunteering", "recommendations"]
