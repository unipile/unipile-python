...
class GetUserProfile200ResponseSpecificsAllOfAnyOfExperienceInner(BaseModel):
    """
    ...
    company: GetUserProfile200ResponseSpecificsAllOfAnyOfExperienceInnerCompany
    ...
    skills: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Skills acquired with experience.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "company": GetUserProfile200ResponseSpecificsAllOfAnyOfExperienceInnerCompany.from_dict(obj["company"]) if obj.get("company") is not None else None,
            "title": obj.get("title"),
