...
class ApplicantsSearch(BaseModel):
    """
    ApplicantsSearch
    """ # noqa: E501
    data: List[ApplicantsSearchDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApplicantsSearchDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
