...
class BrowseSalesAccountListRequest(BaseModel):
    ...
    """ # noqa: E501
    persona: Optional[StrictStr] = Field(default=None, description="A parameter ID. Use <a href=\"https://developer.unipile.com/v2.0/reference/getsalessearchparameters\">List Search Parameters</a> with `PERSONA` type to find out the possible values.    Native filter : Persona   ")
