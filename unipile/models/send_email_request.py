...
class SendEmailRequest(BaseModel):
    ...
    reply_to: Optional[StrictStr] = Field(default=None, description="The ID of the email message that you're replying to. For Gmail and Outlook, this is the provider ID for the email message that you're replying to. For IMAP Send, this is the RFC822 Message-ID header of the email message that you're replying to.")
