...
class StartChatRequestSpecifics(BaseModel):
    """
    Object containing provider-specific chat data.
    """ # noqa: E501
    linkedin: Optional[StartChatRequestSpecificsLinkedin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "linkedin": StartChatRequestSpecificsLinkedin.from_dict(obj["linkedin"]) if obj.get("linkedin") is not None else None
        })
        return _obj
