...
class IMAP(BaseModel):
    ...
    def provider_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['imap']):
            raise ValueError("must be one of enum values ('imap')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": IMAPCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "config": IMAPConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
