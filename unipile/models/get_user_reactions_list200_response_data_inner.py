...
class GetUserReactionsList200ResponseDataInner(BaseModel):
    """
    ...
    sender: GetChatsList200ResponseDataInnerParticipantsInnerUser
    parent_post: Optional[GetUserCommentsList200ResponseDataInnerParentPost]
    __properties: ClassVar[List[str]] = ["object", "value", "is_sender", "sender", "parent_post"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sender": GetChatsList200ResponseDataInnerParticipantsInnerUser.from_dict(obj["sender"]) if obj.get("sender") is not None else None,
