...
class LinkedInProjectsInner(BaseModel):
    ...
    contributors: List[GetChatsList200ResponseDataInnerLastMessageAnyOf1Sender] = Field(description="Contributors to the project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contributors": [GetChatsList200ResponseDataInnerLastMessageAnyOf1Sender.from_dict(_item) for _item in obj["contributors"]] if obj.get("contributors") is not None else None,
