...
class LinkedInProjectsInner(BaseModel):
    """
    ...
    contributors: List[UpdateChat200ResponseParticipantsInnerUser] = Field(description="Contributors to the project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contributors": [UpdateChat200ResponseParticipantsInnerUser.from_dict(_item) for _item in obj["contributors"]] if obj.get("contributors") is not None else None,
