...
class UpdateWebhookEndpointRequest(BaseModel):
    ...
    url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="The HTTP or HTTPS URL to send the webhook payload to.")
