...
class PeopleSearch1(BaseModel):
    """
    PeopleSearch1
    """ # noqa: E501
    data: List[PeopleSearch1DataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PeopleSearch1DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
