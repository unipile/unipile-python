...
class AddPostCommentRequest(BaseModel):
    ...
    comment_as: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="The ID of the User on whose behalf the comment should be published (if supported by the provider).")
