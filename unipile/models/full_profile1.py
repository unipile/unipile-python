...
class FullProfile1(BaseModel):
    ...
    profile_url: StrictStr = Field(description="The profile URL of the User.")
    ...
    recommendations: List[GetUserProfile200ResponseSpecificsAllOfAnyOfRecommendationsReceivedInner]
    __properties: ClassVar[List[str]] = ["object", "product", "visibility", "id", "candidate_id", "headline", "network_distance", "location", "is_hidden_candidate", "work_experience", "can_send_inmail", "display_name", "public_identifier", "profile_url", "industry", "relations_count", "followers_count", "skills", "summary", "public_picture_url", "emails", "phone_numbers", "education", "languages", "certifications", "projects", "volunteering", "recommendations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recommendations": [GetUserProfile200ResponseSpecificsAllOfAnyOfRecommendationsReceivedInner.from_dict(_item) for _item in obj["recommendations"]] if obj.get("recommendations") is not None else None
        })
        return _obj
