...
class FullProfile1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "member_id", "display_name", "public_identifier", "profile_url", "public_picture_url", "public_picture_url_large", "relations_count", "location", "headline", "can_send_inmail", "network_distance", "product", "visibility", "candidate_id", "is_hidden_candidate", "hiring_project", "work_experience", "industry", "followers_count", "skills", "summary", "emails", "phone_numbers", "education", "languages", "certifications", "projects", "volunteering", "recommendations"]
