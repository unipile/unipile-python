...
class EditExistingExperience(BaseModel):
    ...
    job_title: Optional[CreateNewExperienceSkillsInner] = None
    ...
    company: Optional[CreateNewExperienceSkillsInner] = None
    location: Optional[CreateNewExperienceSkillsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "job_title": CreateNewExperienceSkillsInner.from_dict(obj["job_title"]) if obj.get("job_title") is not None else None,
            "employment_type": obj.get("employment_type"),
            "company": CreateNewExperienceSkillsInner.from_dict(obj["company"]) if obj.get("company") is not None else None,
            "location": CreateNewExperienceSkillsInner.from_dict(obj["location"]) if obj.get("location") is not None else None,
