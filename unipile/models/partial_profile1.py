...
class PartialProfile1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "headline", "location", "can_send_inmail", "network_distance", "product", "visibility", "candidate_id", "is_hidden_candidate", "hiring_project", "work_experience"]
