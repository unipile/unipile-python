...
class UpdateUserProfileRequestSpecifics(BaseModel):
    """
    UpdateUserProfileRequestSpecifics
    """ # noqa: E501
    linkedin: Optional[UpdateUserProfileRequestSpecificsAllOfLinkedin] = None
    __properties: ClassVar[List[str]] = ["linkedin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "linkedin": UpdateUserProfileRequestSpecificsAllOfLinkedin.from_dict(obj["linkedin"]) if obj.get("linkedin") is not None else None
        })
        return _obj
