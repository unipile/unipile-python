...
class ModifyEmailRequest(BaseModel):
    ...
    ModifyEmailRequest
    """ # noqa: E501
    folders_ids: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=1)]] = Field(default=None, description="The ID(s) of the folder(s) to apply, overwriting all folders previously associated with the Email. Outlook emails can be in a single folder only. Google allows a single email to appear in multiple folders.")
