...
class GetClassicSearchParameters200Response(BaseModel):
    """
    GetClassicSearchParameters200Response
    """ # noqa: E501
    data: List[GetClassicSearchParameters200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetClassicSearchParameters200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
