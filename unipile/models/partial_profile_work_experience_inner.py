...
class PartialProfileWorkExperienceInner(BaseModel):
    ...
    company: LinkedIn1CertificationsInnerOrganization
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "company": LinkedIn1CertificationsInnerOrganization.from_dict(obj["company"]) if obj.get("company") is not None else None,
