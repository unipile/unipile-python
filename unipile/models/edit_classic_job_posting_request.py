...
class EditClassicJobPostingRequest(BaseModel):
    ...
    location: Optional[StrictStr] = Field(default=None, description="A parameter ID. Use <a href=\"https://developer.unipile.com/v2.0/reference/getclassicsearchparameters\">List Search Parameters</a> with `JOB_LOCATION` type to find out the possible values.")
    ...
    skills: Optional[List[StrictStr]] = Field(default=None, description="A list of parameter IDs. Use <a href=\"https://developer.unipile.com/v2.0/reference/getclassicsearchparameters\">List Search Parameters</a> with `SKILL` type to find out the possible values. The skills related to the job posting.")
