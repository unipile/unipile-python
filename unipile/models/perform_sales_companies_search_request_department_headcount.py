...
class PerformSalesCompaniesSearchRequestDepartmentHeadcount(BaseModel):
    """
    ...
    department: StrictStr = Field(description="A parameter ID. Use <a href=\"https://developer.unipile.com/v2.0/reference/getsalessearchparameters\">List Search Parameters</a> with `JOB_FUNCTION` type to find out the possible values.")
