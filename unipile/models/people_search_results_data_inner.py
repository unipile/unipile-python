...
class PeopleSearchResultsDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "member_id", "display_name", "public_identifier", "profile_url", "public_picture_url", "public_picture_url_large", "relations_count", "location", "headline", "network_distance", "can_send_inmail", "product", "followers_count", "industry", "is_verified", "keywords_match", "is_premium", "is_open_profile", "shared_relations_count", "website_url", "portfolio_url", "services_page_url"]
