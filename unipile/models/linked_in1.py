...
class LinkedIn1(BaseModel):
    ...
    credentials: LinkedIn1Credentials
    config: Optional[LinkedIn1Config] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": LinkedIn1Credentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "config": LinkedIn1Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
