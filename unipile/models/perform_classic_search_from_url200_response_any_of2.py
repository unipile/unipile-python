...
class PerformClassicSearchFromUrl200ResponseAnyOf2(BaseModel):
    """
    PerformClassicSearchFromUrl200ResponseAnyOf2
    """ # noqa: E501
    data: List[PerformClassicSearchFromUrl200ResponseAnyOf2DataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PerformClassicSearchFromUrl200ResponseAnyOf2DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
