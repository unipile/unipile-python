...
class PeopleSearch2(BaseModel):
    """
    PeopleSearch2
    """ # noqa: E501
    data: List[PeopleSearch2DataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PeopleSearch2DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
