...
class DeleteAnExperience(BaseModel):
    """
    DeleteAnExperience
    """ # noqa: E501
    operation: StrictStr
    id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ID of the experience to delete.")
    __properties: ClassVar[List[str]] = ["operation", "id"]
