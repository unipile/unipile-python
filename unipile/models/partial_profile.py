...
class PartialProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "headline", "location", "can_send_inmail", "network_distance", "visibility", "candidate_id", "is_hidden_candidate", "hiring_project", "work_experience"]
