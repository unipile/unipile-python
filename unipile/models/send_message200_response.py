...
class SendMessage200Response(BaseModel):
    """
    SendMessage200Response
    """ # noqa: E501
    object: StrictStr
    message_id: Optional[SendMessage200ResponseMessageId]
    __properties: ClassVar[List[str]] = ["object", "message_id"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['MessageSent']):
            raise ValueError("must be one of enum values ('MessageSent')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message_id": SendMessage200ResponseMessageId.from_dict(obj["message_id"]) if obj.get("message_id") is not None else None
        })
        return _obj
