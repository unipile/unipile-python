        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.headcount:
            for _item_headcount in self.headcount:
                _items.append(_item_headcount.to_dict() if _item_headcount is not None else None)
        ...
        if self.followers:
            for _item_followers in self.followers:
                _items.append(_item_followers.to_dict() if _item_followers is not None else None)
        ...
        if self.fortune:
            for _item_fortune in self.fortune:
                _items.append(_item_fortune.to_dict() if _item_fortune is not None else None)
