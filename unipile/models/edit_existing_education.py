...
class EditExistingEducation(BaseModel):
    ...
    school: Optional[CreateNewExperienceSkillsInner] = None
    degree: Optional[CreateNewExperienceSkillsInner] = None
    field_of_study: Optional[CreateNewExperienceSkillsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "school": CreateNewExperienceSkillsInner.from_dict(obj["school"]) if obj.get("school") is not None else None,
            "degree": CreateNewExperienceSkillsInner.from_dict(obj["degree"]) if obj.get("degree") is not None else None,
            "field_of_study": CreateNewExperienceSkillsInner.from_dict(obj["field_of_study"]) if obj.get("field_of_study") is not None else None,
