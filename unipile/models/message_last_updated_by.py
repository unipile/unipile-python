...
class MessageLastUpdatedBy(BaseModel):
    """
    ...
    specifics: Optional[MessageLastUpdatedBySpecifics] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specifics": MessageLastUpdatedBySpecifics.from_dict(obj["specifics"]) if obj.get("specifics") is not None else None
        })
        return _obj
