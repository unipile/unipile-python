...
class PeopleSearch1DataInner(BaseModel):
    """
    ...
    websites: Optional[List[Optional[StrictStr]]] = Field(default=None, description="A list of websites of the User.")
    addresses: Optional[List[Optional[StrictStr]]] = Field(default=None, description="A list of addresses of the User.")
    contact_info: PeopleSearch1DataInnerContactInfo
    ...
    social_handles: Optional[PeopleSearch1DataInnerSocialHandles] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_info": PeopleSearch1DataInnerContactInfo.from_dict(obj["contact_info"]) if obj.get("contact_info") is not None else None,
            ...
            "social_handles": PeopleSearch1DataInnerSocialHandles.from_dict(obj["social_handles"]) if obj.get("social_handles") is not None else None,
