...
class GetClassicCompanyProfile200Response(BaseModel):
    ...
    profile_url: Optional[StrictStr] = Field(default=None, description="The public profile URL of the Company.")
    ...
    followers_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of followers of the Company.")
    is_following: Optional[StrictBool] = Field(default=None, description="Whether the current user is following the Company.")
    object: StrictStr
    ...
    acquired_by: Optional[LinkedInInterestsCompaniesInner] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "profile_url", "public_picture_url", "public_identifier", "followers_count", "is_following", "object", "description", "tagline", "is_school", "is_active", "is_archived", "is_employee", "is_verified", "is_claimable", "is_claimable_by_viewer", "verified_at", "mailbox", "viewer_roles", "locations", "industry", "activities", "website", "establishment_year", "phone", "fields_of_expertise", "acquired_by", "insights", "funding", "hashtags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acquired_by": LinkedInInterestsCompaniesInner.from_dict(obj["acquired_by"]) if obj.get("acquired_by") is not None else None,
