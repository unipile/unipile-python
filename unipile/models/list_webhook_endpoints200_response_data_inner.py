...
class ListWebhookEndpoints200ResponseDataInner(BaseModel):
    ...
    """ # noqa: E501
    enabled: StrictBool
    description: Optional[StrictStr] = Field(description="The text content of the message, when available.")
    url: Optional[StrictStr] = Field(description="The text content of the message, when available.")
