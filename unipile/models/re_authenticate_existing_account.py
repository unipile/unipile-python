...
class ReAuthenticateExistingAccount(BaseModel):
    ...
    account_id: Annotated[str, Field(strict=True)] = Field(description="Required to re-authenticate or reconfigure an existing account. The entire account is refreshed and all configured products are restarted.")
    __properties: ClassVar[List[str]] = ["account_scope_id", "expires_on", "domain", "redirect_uri", "state", "config", "account_id"]
