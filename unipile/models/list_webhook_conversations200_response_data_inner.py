...
class ListWebhookConversations200ResponseDataInner(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(description="The text content of the message, when available.")
    http_status: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]
    endpoint_url: Optional[StrictStr] = Field(description="The text content of the message, when available.")
