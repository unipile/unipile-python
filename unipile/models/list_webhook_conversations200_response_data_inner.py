...
class ListWebhookConversations200ResponseDataInner(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(description="Unique identifier of the job posting.")
    http_status: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]
    endpoint_url: Optional[StrictStr] = Field(description="Unique identifier of the job posting.")
    response_body: Optional[StrictStr] = Field(description="Unique identifier of the job posting.")
    object: StrictStr
