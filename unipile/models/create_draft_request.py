...
class CreateDraftRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["html", "plain_text", "subject", "from", "to", "cc", "bcc", "reply_to", "attachments", "tracking_options"]
