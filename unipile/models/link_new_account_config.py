...
class LinkNewAccountConfig(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "google": LinkNewAccountConfigGoogle.from_dict(obj["google"]) if obj.get("google") is not None else None,
            ...
            "whatsapp": LinkNewAccountConfigWhatsapp.from_dict(obj["whatsapp"]) if obj.get("whatsapp") is not None else None,
            ...
            "telegram": Telegram1Config.from_dict(obj["telegram"]) if obj.get("telegram") is not None else None,
