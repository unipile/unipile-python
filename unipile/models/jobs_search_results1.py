...
class JobsSearchResults1(BaseModel):
    """
    JobsSearchResults1
    """ # noqa: E501
    data: List[JobsSearchResults1DataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [JobsSearchResults1DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
