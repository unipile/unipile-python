...
class WhatsApp2(BaseModel):
    ...
    credentials: WhatsApp2Credentials
    config: Optional[WhatsApp2Config] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credentials": WhatsApp2Credentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "config": WhatsApp2Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
