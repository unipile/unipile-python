...
class SendMessageRequestSpecifics(BaseModel):
    """
    Object containing provider-specific message data.
    """ # noqa: E501
    linkedin: Optional[SendMessageRequestSpecificsLinkedin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "linkedin": SendMessageRequestSpecificsLinkedin.from_dict(obj["linkedin"]) if obj.get("linkedin") is not None else None
        })
        return _obj
