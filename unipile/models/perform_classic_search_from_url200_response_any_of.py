...
class PerformClassicSearchFromUrl200ResponseAnyOf(BaseModel):
    """
    PerformClassicSearchFromUrl200ResponseAnyOf
    """ # noqa: E501
    data: List[PerformClassicSearchFromUrl200ResponseAnyOfDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PerformClassicSearchFromUrl200ResponseAnyOfDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
