...
class NewExperience(BaseModel):
    ...
    job_title: Optional[NewExperienceJobTitle] = None
    employment_type: Optional[Annotated[str, Field(strict=True)]] = None
    company: Optional[NewExperienceCompany] = None
    location: Optional[NewExperienceLocation] = None
    ...
    __properties: ClassVar[List[str]] = ["notify_network", "job_title", "employment_type", "company", "location", "workplace_type", "start_date", "end_date", "description", "source_of_hire", "skills", "attachment", "attachment_title", "attachment_description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "job_title": NewExperienceJobTitle.from_dict(obj["job_title"]) if obj.get("job_title") is not None else None,
            "employment_type": obj.get("employment_type"),
            "company": NewExperienceCompany.from_dict(obj["company"]) if obj.get("company") is not None else None,
            "location": NewExperienceLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
