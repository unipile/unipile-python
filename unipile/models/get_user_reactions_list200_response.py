...
class GetUserReactionsList200Response(BaseModel):
    """
    GetUserReactionsList200Response
    """ # noqa: E501
    data: List[GetUserReactionsList200ResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GetUserReactionsList200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
