...
class GetPostsList200ResponseDataInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["object", "id", "share_url", "created_at", "title", "text", "user_reacted", "permissions", "reactions_counter", "comments_counter", "reposts_counter", "poll", "event", "attachments", "analytics", "is_repost", "author", "reposted_by", "quoted_post"]
